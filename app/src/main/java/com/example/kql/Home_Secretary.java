...
public class Home_Secretary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            {
                fb.signOut();
                startActivity(new Intent(Home_Secretary.this, Login.class));
                finish();
            } else if (id == R.id.nav_add_member) {
                startActivity(new Intent(Home_Secretary.this, CreateMember.class));

            } else if (id == R.id.nav_host_live_quiz) {
                startActivity(new Intent(Home_Secretary.this, LiveQuiz.class));

            }
            else if(id == R.id.nav_leaderboard)
            {
                startActivity(new Intent(Home_Secretary.this, LeaderBoard.class));
            }
            else if(id ==R.id.nav_check_quiz)
            {
                Bundle bundle = new Bundle();
                bundle.putString("Start", "False");
                startActivity(new Intent(Home_Secretary.this, UpcmingLiveQuiz.class).putExtras(bundle));
            }
            drawer.closeDrawers();
            return true;
        });
